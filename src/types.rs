/*
Primitive types
Integers: u8, i8, u16, i16, u32, i32, u64, i64, u128, i128 (number of bites they take in memory)
Floats: f32, f64
Boolean (bool)
Characters (char)
Tuples
...
pub fn run() {
    ...
    println!("{:?}", (x, y, z, is_active, is_active2, is_greater, a1, face));
}